...
cp native/build-x64/src/Release/Torva.exe build/win-x64/
cp target/Torva.jar build/win-x64/
...
echo Torva.exe 64bit sha256sum
sha256sum build/win-x64/Torva.exe

dumpbin //HEADERS build/win-x64/Torva.exe
