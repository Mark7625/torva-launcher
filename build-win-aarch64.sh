...
cp native/build-aarch64/src/Release/Torva.exe build/win-aarch64/
cp target/Torva.jar build/win-aarch64/
...
echo Torva.exe aarch64 sha256sum
sha256sum build/win-aarch64/Torva.exe

dumpbin //HEADERS build/win-aarch64/Torva.exe
