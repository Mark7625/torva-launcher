...
cp native/build-x86/src/Release/Torva.exe build/win-x86/
cp target/Torva.jar build/win-x86/
...
echo Torva.exe 32bit sha256sum
sha256sum build/win-x86/Torva.exe

dumpbin //HEADERS build/win-x86/Torva.exe
